#include <pch.h>
#include "L_PursueClosestScissor.h"
#include "Agent/BehaviorAgent.h"
#include "utility.h"

void L_PursueClosestScissor::on_enter()
{
...
void L_PursueClosestScissor::on_update(float dt)
{
    utils::leaveFootprint(agent);

    Agent* target = agents->searchAgentTypeWithID(targetAgent, typeScissor);
    if (target == nullptr) {
        on_failure();
        return;
    }
